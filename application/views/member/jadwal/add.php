    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/jadwal/doAdd'?>" role="form"> 
                       <?php 
                       ...
                       echo $this->session->flashdata('msgbox');?>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="form-field-1" name="txtKode" value="<?php echo $dataOld['txtKode']; ?>" class="col-xs-10 col-sm-5" required/>
                            </div>
                        </div>
						<div class="form-group">
                            ...
                            <div class="col-sm-2">
								<div class="clockpicker1">
									...
									<div class="input-group">
										<input type="text" class="form-control" name="txtStart" value="<?php echo $dataOld['txtStart']; ?>" placeholder="Jam mulai" required>
								...
								<i>Selesai</i>
									<div class="input-group">
										<input type="text" class="form-control" name="txtFinish" value="<?php echo $dataOld['txtFinish']; ?>" placeholder="Jam selesai" required>
										<span class="input-group-addon">
											<span class="glyphicon glyphicon-time"></span>
										</span>
									</div>
