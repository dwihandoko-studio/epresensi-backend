    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/karyawan/doAdd/'?>" role="form"> 
                       <?php 
                       ...
                       echo $this->session->flashdata('msgbox');?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="txtNamaKaryawan" value="<?php echo $dataOld['txtNamaKaryawan']; ?>" placeholder="Isi nama karyawatan" class="col-xs-10 col-sm-5" required/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="txtAlamat" value="<?php echo $dataOld['txtAlamat']; ?>" placeholder="Isi alamat karyawan" class="col-xs-10 col-sm-5" required/>
                            </div>
                        </div>
                        <div class="form-group">
