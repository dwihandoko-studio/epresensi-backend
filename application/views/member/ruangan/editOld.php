    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
			 ...
			 function setSelection(shape) {
			  ...
			  function gambarMap() {
				var map = new google.maps.Map(document.getElementById('map'), {
				  zoom: 14,
				  center: new google.maps.LatLng(-6.212736,106.819141),
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo base_url('admin/ruangan/daftar') ?>">Ruangan</a>
                </li>
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/ruangan/doEdit/'.$this->uri->segment(4); ?>" role="form"> 
                       <?php 
                       ...
                       echo $this->session->flashdata('msgbox');?>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="txtKode" value="<?php echo $dataDetail['kode']; ?>" placeholder="Isi kode" class="col-xs-10 col-sm-5" required readonly/>
                            </div> 
                        </div>
						<div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Ruangan</label>
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="txtRuangan" value="<?php echo $dataDetail['ruangan']; ?>" placeholder="Isi ruangan" class="col-xs-10 col-sm-5" required/>
                            </div> 
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Lantai</label>
                            <div class="col-sm-2">
                                <input type="number" id="form-field-1" name="txtLantai" value="<?php echo $dataDetail['lantai']; ?>" placeholder="Isi lantai" class="col-xs-10 col-sm-5" required/>
                            </div> 
                        </div>
						<div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Koordinat North East</label>
                            <div class="col-sm-9">
						...
						<div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Koordinat South West</label>
                            <div class="col-sm-9">
