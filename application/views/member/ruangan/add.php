    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/ruangan/doAdd'?>" role="form"> 
                       <?php 
                       ...
                       echo $this->session->flashdata('msgbox');?>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="form-field-1" name="txtRuangan" value="<?php echo $dataOld['txtRuangan']; ?>" placeholder="Isi ruangan" class="col-xs-10 col-sm-5" required/>
                            </div> 
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Lantai</label>
                            <div class="col-sm-2">
                                <input type="number" id="form-field-1" name="txtLantai" value="<?php echo $dataOld['txtLantai']; ?>" placeholder="Isi lantai" class="col-xs-10 col-sm-5" required/>
                            </div> 
                        </div>
						<div class="form-group">
