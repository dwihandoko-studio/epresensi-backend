    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/gajihan/nextWizard/'?>" role="form"> 
                       <?php 
                       ...
                       echo $this->session->flashdata('msgbox');?>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Periode Gajihan</label>
                            ...
                            <div class="col-sm-9">
                                ...
                                <select name="spinPeriodeTahun" class="col-xs-5 col-sm-2">
